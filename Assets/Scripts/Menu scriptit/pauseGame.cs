...
//     version 1.17.0
//     from Assets/Samu Testing/Scripts/menu/pauseGame.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/Samu Testing/Scripts/menu/pauseGame.inputactions".
/// </summary>
/// <remarks>
...
public partial class @PauseGame: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        {
            ""name"": ""pause"",
            ""id"": ""bbdc40db-4fac-4930-b57e-693b7f9e8fa8"",
            ""actions"": [
                {
                    ""name"": ""Pausegame"",
                    ""type"": ""Button"",
                    ""id"": ""cf0bd2b9-da6e-47cc-bea5-ac74c90e82fe"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""05ec047a-82f5-4497-a5b4-3fd01095fc1e"",
    ...
    ~@PauseGame()
    {
        UnityEngine.Debug.Assert(!m_pause.enabled, "This will cause a leak and performance issues, PauseGame.pause.Disable() has not been called.");
    }
